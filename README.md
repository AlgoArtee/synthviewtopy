...
npm run test:residential-ever-hour # Audit the integrated 36-building residential and 23-building guest district
npm run test:entertainment       # Audit the 20-building Luminous Crescent entertainment district
...
## Electronics / Micro-Electronics Labs District

The north-western middle-ring Electronics / Micro-Electronics Labs District is an exterior-only semiconductor ecosystem organized around the pale **Signal Spine**. Graphite ceramic, pale technical porcelain, titanium, oxidized copper, black glass, restrained iridescent coatings, and translucent fluoropolymer define a precise research arc between expressive soft/photonic systems and protected logic, cryogenic, power, and metrology programs.

- **Fabrica Ångström** stacks dark n-type and pale p-type logic volumes across a razor dielectric seam, with eight structural gate loops, dense forksheet fins, backside copper power channels, a continuous observation strip, and aligned cleanroom plant.
- **The Interposer Exchange** assembles eight heterogeneous chiplet blocks above a copper-routed substrate podium, linked by ribbed data bridges and a wall of independently illuminated glass microbumps.
- **Lumen Weave Institute** forms an incomplete optical ring from two iridescent glass wings, etched waveguide pulses, resonator frames, a continuous pearlescent ribbon, calibration domes, and black optical pools.
- **Kelvin Null Center** separates three nested thermal shells with cold diagnostic gaps, heavy expansion rings, vacuum-jacketed umbilicals, helium-recovery vessels, radiator fins, and concentric frost-controlled paving.
- **Synaptic Stack Laboratory** raises a graphite matrix tower from three oxide-red dendritic wings; slow electrochromic memory fields, branching rain canopy, cooling plates, and event-like light nodes express retained architectural state.
- **The Spin-Orbit Vault** places a ferrite core behind two incomplete magnetic-domain walls, with fixed moiré fins, alternating radial roof fields, tangential access, magnetometer masts, and slowly reorienting plaza stones.
- **Aegis Power Bastion** encloses a rail-served high-voltage test canyon between two finned heat-sink blocks, exposing shielded copper busbars, ceramic buttresses, retractable Faraday screens, radiator towers, and grounded artificial-tree masts.
- **The Terahertz Metrology Spire** changes from square to octagonal section beneath phased-array rings and a needle radome, above three anechoic courts, a surveyed calibration line, movable antenna facets, and twisting waveguide bridges.
- **The Adaptive Skin Pavilion** folds a translucent responsive membrane over pearlescent soft-edged volumes, conductive inner meshes, branching frames, fibre canopies, warm-water trials, and protected printed sensor ribbons.
- **Sensorium Hive** surrounds an open calibration field with twelve hexagonal and circular modality volumes for pressure, capacitive, optical, piezoelectric, acoustic, thermal, and antenna systems, below cable-borne sensor carriers and irregular microclimate needles.
- Five thin power, data, timing, cooling, and optical traces run through the grounded Signal Spine and terminate at ten thin bond-pad plazas. Offset glass undercroft cuts reveal moving utility carriers without interrupting WALK; a separate backside power-delivery arc and automated material-transfer arc remain non-public. The 1,756-mesh, approximately 176,500-triangle package stays inside its middle-ring cell with zero facility overlaps and supports streaming, revision-27 persistence migration, selection, compact/deep text state, deterministic animation, WALK navigation, and GLB export. Interiors remain intentionally deferred by the exterior specification.

## Scientific Art and Marketing District

The northwestern outer-middle research arc is now one continuous translation district where scientific work becomes images, objects, experiences, narratives, and identities before reaching public audiences. A curved **Spectrum Spine** joins the inward-facing Scientific Art laboratories to the outward-facing Marketing institutions through Prism Forum, Translation Garden, and the deliberately adaptable Unfinished Promenade. Black titanium, low-iron glass, pearlescent ceramic, brushed aluminum, translucent photovoltaics, dichroic films, and pale geopolymer unify the two halves without erasing their different characters.

- The Scientific Art crescent contains eight distinct institutes: the finned **Parallax Institute**, shell-and-robot **Morphogenesis Fabrication Hall**, seven-pod **Chromaflux Bioart Conservatory**, five-volume **Resonance Foundry**, prism-towered **Lumen Observatory**, six-slide **Atlas of Invisible Worlds**, weathering-strip **Archive of Future Materials**, and nearly lightless **Null Field Gallery**.
- The Marketing crescent contains seven outward-facing civic-production institutions: wave-screened **Signal House**, radial-canopy **Launch Array**, modular **Narrative Engine Media Foundry**, responsive-cell **Audience Dynamics Observatory**, reconfigurable **Prototype Identity Works**, ring-crowned **Beacon Exchange Tower**, and colonnaded **Evidence Commons**.
- Directional light bands, limited abstract media surfaces, exact approaches, restrained operational animation, and grounded public routes preserve the specified low-light research-island identity. The 1,514-mesh, approximately 163,650-triangle package stays inside its shared sector with zero facility-envelope overlaps and supports HLOD streaming, revision-28 persistence migration, per-building selection, compact/deep text state, WALK navigation, and GLB export. Interiors remain intentionally deferred by the exterior specification.

## Luxury / Entertainment District — The Luminous Crescent

The northwestern outer-ring entertainment arc is a compressed experimental night city organized around the curved, walkable **Lumen Boulevard** and three open-air **Halo Walk** bridge spans. Champagne titanium, black ceramic, polished stone, low-iron glass, wet-look basalt, reflecting water, kinetic metal screens, and integrated structural neon remain refined by day and vivid after dark.

- The loud outer-northern skyline contains **Pulse Cathedral**, **Halo Nine**, **Probability Palace**, **Chrono Carousel**, and ocean-facing **Tidal Glass**. Acoustic buttresses, landscape buffers, shielded light, and the outer-road setback keep their scale and motion away from accommodation and ecological edges.
- The Scientific Art / Marketing transition contains **The Aurelia Crown**, **The Helix Table**, **Eclipse Cabaret**, **Aurora Grand Cinema**, **The Prismarium**, and **Synesthesia Hall**. Their floating halos, helical promenade, mechanical crescent, aurora fins, suspended cube, and responsive waveform facade turn scientific optics, media, materials, and performance into civic spectacle.
- The quieter inner edge contains **Ember & Ice**, **The Orion Room**, **Velvet Circuit**, **Zero-G Ballroom**, and **Dream Arcade**, using warm downward-directed lighting, acoustic landscaping, reflective basins, kinetic curtains, gyroscopic rings, and visible capsule circulation beside Ever Hour and Residential routes.
- The Tropical Dome transition contains **Horizon Screen Gardens**, **Meridian Pool Palace**, **Neon Grotto Aquaclub**, and **The Phantom Menagerie**, where open terraces, transparent aquatic vaults, volcanic lagoon shells, mist, luminous wetlands, vegetation, and speculative biome cells dissolve the hard neon city into artificial ecology.
- All twenty buildings have distinct authored exterior roots, integrated signs, short boulevard approaches, stable selection/edit metadata, revision-29 persistence migration, compact/deep text state, streaming animation profiles, WALK collision, and GLB export. The focused audit covers 1,143 meshes, approximately 233,440 source triangles, all signature-system counts, 24 walkable routes, zero facility-envelope overlaps, zero sector violations, and grounded human-scale navigation. Interiors remain intentionally deferred by the supplied exterior-only specification.

## Financial / Funding / Convention District

The island's northern outer edge is now a three-zone institutional landscape that moves from precise finance through civic funding to the open scale of international convention grounds. Black basalt, pale engineered stone, brushed titanium, bronze, satin ceramic, low-iron glass, controlled white light, and restrained cyan, violet, and red-orange signals establish a shared exterior language.

- **Capital Crescent** contains the three-ledger-slab **Aequitas Exchange**, offset **Meridian Research Bank**, crystalline **Venture Prism**, fissured **Patron Constellation Hall**, and disc-crowned **Chronos Futures Observatory**.
- **Funding Spine** connects the paired spiral wings of **Helix Grant House**, double-skin **Patent Lantern**, leaning **Black Swan Risk Tower**, terraced **Impact Ledger**, encryption-matrix **Clearing Vault**, and repaired-seam **Arbitration Basilica**.
- **Confluence Grounds** expands into the equal-fin **Sovereign Science Fund Forum**, vast crescent **Astra Confluence Convention Centre**, six reconfigurable **Modular Congress Yards**, and torsion-form **Delegate Spire**.
- Three grounded promenades, fifteen exact approaches, a direct convention transit line, an enclosed moving walkway, formal groves, rain gardens, integrated signage, and sparse operational animation bind the zones together. The focused audit covers all 15 facilities, 1,508 meshes, approximately 259,200 source triangles, 19 walkable routes, zero facility-envelope overlaps, zero sector violations, and grounded human-scale navigation. The package supports streaming, revision-30 persistence migration, per-building selection, compact/deep text state, WALK collision, and GLB export. Interiors remain intentionally deferred by the supplied exterior specification.

## Corporate Core — The Black Ring

The island's innermost administrative ring now contains twenty inward-facing black institutions arranged clockwise around the preserved central Black Megabuilding. Basalt, obsidian, black titanium, carbon composite, electrochromic glass, and rare pale accents keep the district deliberately light-absorbing, while cyan, ultraviolet, magenta, amber, green, and red neon identify institutional function rather than decorate the architecture.

- The financial and governance arc moves from **Null Exchange**, **Obsidian Reserve**, **Black Ledger Authority**, **Quantum Clearing House**, and **Black Index Bureau** into **Vanta Venture Spire**, **Covenant Capital House**, **Patronage Engine**, **Legacy Endowment**, and **Silent Patent Auction**.
- The risk, law, convention, and consensus arc continues through **Umbra Underwriting Hall**, **Catastrophe Bond Tower**, **Arbitration Basilica**, **Event Horizon Convention Centre**, **Mourningstar Plenary Hall**, **Eclipse Expo Galleries**, **Funding Crucible**, **Last Prospectus Media House**, **Nocturne Delegation Tower**, and **Crown of Consensus**.
- The concentric **Compliance Walk** and **Procession Loop**, twenty exact inward approaches, sealed central gates, inward-facing seating, floating declarations, and six grounded cyan/magenta light pavilions make the full ring legible while leaving the preserved central Black Megabuilding untouched. Each 16.4 m-wide pavilion rests on the plaza and contains one round table, four inward-facing chairs, collision-aware furniture, three human-scale upper emitter panels and columns, six smooth transparent light-current ribbons, and only 28 dim holographic points. Subtle emissive edges provide definition without a local point-light pool. The obsolete central campus buildings and generated roads remain retired, the island's three arterial axes stop outside the Black Ring, the stray outer-ring connector is explicitly suppressed so no black road crosses the central plaza, and there are no building-to-center skybridges. A high-output night network adds 80 promenade pylons and lanterns, 60 compliance shards, 120 facade lights, 40 rooftop emitters, 16 local point lights, and twenty building-aligned stadium-light rigs. Each rig has a titanium stanchion, three visible floodlight heads, and a broad shadowless spotlight aimed into the plaza; these plaza spotlights remain active in Explore even when **Full Island Detail** is enabled. The standalone toolbar **Atmosphere** menu controls time, weather, season, and the persistent 0-200% Corporate plaza-light strength; the Masterplan directory now retains only rendering controls. The focused audit covers all 20 facilities, 22 walkable routes, 20 stanchions/spotlights, distinct signature systems, grounded human-scale navigation, the six light pavilions, the isolated central plaza, and explicit central-preservation checks. The package supports streaming, revision-32 persistence migration, per-building selection, compact/deep text state, deterministic neon and kinetic animation, WALK collision, and GLB export. Interiors remain intentionally deferred by the supplied exterior specification.
...
## Residential Scientists and Ever Hour Districts

The western **Residential Scientists District** and adjacent **Ever Hour Hotel / Guest Scientists District** now form one exterior-only live-work continuum. Twenty original permanent residential, civic, wellness, childcare, food, clinic, and bookable-workshop facilities plus sixteen huge scientist-apartment ensembles transition into twenty-three guest hotels, conference spaces, micro-laboratories, pools, recovery, dining, retail, and scientific-supply buildings.

- The residential half is an organic cyberpunk-neon neighborhood. The original R01-R20 silhouettes retain their domestic and civic functions beneath fully opaque dark alloy, ceramic, indigo, cyan, opaline, photovoltaic, and holographic-panel surfaces; their cyan/magenta/violet rails, facade bands, and address fins keep the established palette without see-through building masses. Only reflecting pools and rain channels remain translucent. R21-R27 occupy the outer-crescent, southern-perimeter, and Continuum-edge contours as 90-122 m apartment stacks. R28-R36 form a staggered 72-102 m scientist-housing cluster in the highlighted northwestern pocket inside the canonical Residential boundary, with communal skybridges, inhabited balcony signals, elevated gardens, photovoltaic fins, and prismatic crowns. The Environmental Science perimeter belt contains no Residential buildings or roads.
- Ever Hour remains visibly awake through basalt, bronze glass, opaline laboratory lanterns, controlled booking/status strips, all-hour food and retail, Chronogarden, Rain Court, Redshift Grove, Bench Garden, and active laboratory/service interfaces toward Robotics. At its civic middle, the 132-metre **The Ever Hour** flagship hotel rises as four monumental room towers around the public crossing, joined by sky lobbies beneath an astronomical time crown and illuminated name facade.
- The slim shared **Continuum Walk** closes at the district seam and changes shelter language from planted pergolas, stone colonnades, and timber-glass canopies to enclosed hotel bridges, photovoltaic laboratory roofs, and dark metal mall arcades. Fifteen Residential and nine Ever Hour neighborhood lanes branch into calm, cornered spines, alternating crosswalks, contour-following neon promenades, a green-pocket residential weave, and three small corner courts; all 59 facilities use deterministic placement, and 58 retain organic stagger and rotation while the central flagship holds the exact civic midpoint. Every facility has a short approach instead of a full-span straight connector, and the Continuum plus its cornered crosswalk remain open through The Ever Hour's ground-level passages. Three walking-time lines, a southern service lane, an eastern laboratory lane, and ten public landscapes maintain the specified public/service and light/noise gradients.
- Both authored sectors participate in full-island GPU batching, revision-24 persistence migration, stable per-building selection metadata, compact/deep text-state inspection, WALK collision, Plan presentation, and GLB export. Interiors remain intentionally deferred by the exterior specification.
...
| `src/world/residentialEverHourDistrict.ts` | Integrated 36-building opaque cyberpunk-neon Residential Scientists and 23-building Ever Hour exteriors, including sixteen scientist-apartment ensembles and The Ever Hour flagship hotel, with organic deterministic placement, a slim Continuum Walk, cornered neighborhood lanes, a green-pocket weave, ten public landscapes, separated service lanes, and operating/light/noise gradients |
| `src/world/entertainmentDistrict.ts` | Twenty-building Luminous Crescent exterior, four protected intensity/ecology bands, Lumen Boulevard, open-air Halo Walk, integrated architectural signage, reflecting water, luminous landscape, and deterministic light/kinetic systems |
| `src/world/financialFundingDistrict.ts` | Fifteen-building Financial/Funding/Convention exterior, three-zone masterplan, grounded promenades and approaches, direct convention transit, enclosed moving walkway, institutional landscaping, integrated signage, and restrained operational animation |
