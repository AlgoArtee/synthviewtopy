...
try {
  ...
  if (audit.population?.realizedFacilityCount !== 10 || audit.population?.inferenceSpineNarrative !== true || audit.specializedRevision !== 14 || audit.streaming?.detailResident !== true || audit.planning?.cellViolations !== 0) throw new Error('Computational Biology integration metadata regressed');
