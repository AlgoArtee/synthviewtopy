...
try {
  ...
  if (audit.population?.realizedFacilityCount !== 10 || audit.population?.semiconductorEcosystemNarrative !== true || audit.population?.signalSpineWalkable !== true || audit.specializedRevision !== 28 || audit.streaming?.detailResident !== true || audit.planning?.cellViolations !== 0 || audit.selected?.packageId !== districtId) throw new Error('Electronics integration metadata regressed');
