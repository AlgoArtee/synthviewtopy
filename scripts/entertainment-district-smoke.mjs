...
try {
  ...
  if (audit.program?.buildingCount !== 20 || audit.compact?.buildingCount !== 20 || audit.deepProgram?.buildingCount !== 20 || audit.specializedRevision !== 29 || audit.planning?.cellViolations !== 0) throw new Error('Entertainment integration metadata incomplete');
