...
const districtIds = ['security', 'secret-labs', 'medical-labs', 'pharmacology-labs', 'microbiology-labs', 'molecular-biology-labs', 'bioanalytics-lab', 'forensic-cyberforensic-lab'];
const roadNames = {
...
try {
  ...
  if (audit.storedRevision !== 6 || audit.textRevision !== 6) {
