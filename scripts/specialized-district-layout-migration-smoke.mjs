...
const roadNames = {
  ...
  'toxicology-labs': 'TOXICOLOGY__DOSE_RESPONSE_PROMENADE',
  'electronics-microelectronics-labs': 'ELECTRONICS__SIGNAL_SPINE',
  'scientific-art-labs': 'ARTMARK__SA__SPECTRUM_SPINE_INNER_HALF',
  ...
  'robotics-labs': 'ROBOTICS__KINEMATIC_WALK',
...
try {
  ...
  if (audit.storedRevision !== 28 || audit.textRevision !== 28) {
