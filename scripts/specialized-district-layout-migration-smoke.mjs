...
const districtIds = ['security', 'secret-labs', 'medical-labs', 'pharmacology-labs', 'microbiology-labs', 'molecular-biology-labs', 'bioanalytics-lab', 'forensic-cyberforensic-lab', 'genomics-labs'];
const roadNames = {
...
try {
  ...
  if (audit.storedRevision !== 7 || audit.textRevision !== 7) {
