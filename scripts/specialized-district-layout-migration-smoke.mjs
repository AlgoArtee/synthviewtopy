...
const districtIds = ['security', 'secret-labs', 'medical-labs', 'pharmacology-labs', 'microbiology-labs', 'molecular-biology-labs', 'bioanalytics-lab'];
const roadNames = {
...
try {
  ...
  if (audit.storedRevision !== 5 || audit.textRevision !== 5) {
