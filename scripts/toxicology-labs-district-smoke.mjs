...
try {
  ...
  if (audit.population?.realizedFacilityCount !== 5 || audit.population?.doseMechanismCountermeasureNarrative !== true || audit.specializedRevision !== 28 || audit.streaming?.detailResident !== true || audit.planning?.cellViolations !== 0 || audit.compactSelected?.packageId !== districtId) throw new Error('Toxicology integration metadata regressed');
