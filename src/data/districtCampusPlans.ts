...
export const DISTRICT_CAMPUS_PLANS = {
  ...
  'financial-funding': {
    facilities: [
      { name: 'The Aequitas Exchange', form: 'tower' },
      { name: 'Meridian Research Bank', form: 'administration' },
      { name: 'Venture Prism', form: 'tower' },
      { name: 'Helix Grant House', form: 'administration' },
      { name: 'The Patent Lantern', form: 'tower' },
      { name: 'Black Swan Risk Tower', form: 'tower' },
      { name: 'The Impact Ledger', form: 'tower' },
      { name: 'Patron Constellation Hall', form: 'hall' },
      { name: 'Sovereign Science Fund Forum', form: 'hall' },
      { name: 'The Clearing Vault', form: 'administration' },
      { name: 'Astra Confluence Convention Centre', form: 'hall' },
      { name: 'The Modular Congress Yards', form: 'hangar' },
      { name: 'The Delegate Spire', form: 'tower' },
      { name: 'The Arbitration Basilica', form: 'hall' },
      { name: 'Chronos Futures Observatory', form: 'tower' },
    ],
    objects: [
      { name: 'Capital Crescent Promenade', kind: 'street-furniture' },
      { name: 'Funding Spine Promenade', kind: 'street-furniture' },
      { name: 'Confluence Grounds Promenade', kind: 'street-furniture' },
      { name: 'Direct Convention Transit Line', kind: 'vehicle' },
      { name: 'Enclosed Moving Walkway', kind: 'street-furniture' },
      { name: 'Formal Groves and Linear Rain Gardens', kind: 'garden' },
      { name: 'Integrated Multilingual Architectural Signage', kind: 'signage' },
    ],
  },
  logistics: {
    facilities: [
