...
const SPECIALIZED_DISTRICT_LAYOUT_REVISION_BY_ID: Readonly<Record<string, number>> = {
  ...
  'robotics-labs': 18,
  'electronics-microelectronics-labs': 27,
  'biochemistry-labs': 8,
...
const GPU_SHARED_ANIMATION_PROFILES = new Set([
  ...
  'robotics-emissive-pulse',
  'electronics-emissive-pulse',
...
export class IslandWorld {
  ...
  private update(delta: number) {
    ...
    activeAnimatedObjects.forEach((object) => {
      ...
      if (object.userData.animate === 'ring-pod') {
      ...
      } else if (object.userData.animate === 'genomics-emissive-pulse') {
        if (object instanceof THREE.Mesh && object.material instanceof THREE.MeshStandardMaterial) {
          const wave = Math.max(0, Math.sin(
            this.elapsed * Number(object.userData.speed ?? 0.014) * Math.PI * 2
            + Number(object.userData.phase ?? 0),
          ));
          object.material.emissiveIntensity = THREE.MathUtils.lerp(
            Number(object.userData.minIntensity ?? 0.24),
            Number(object.userData.maxIntensity ?? 3.9),
            Math.pow(wave, 3),
          );
        }
      } else if (object.userData.animate === 'genomics-rotation') {
      ...
      } else if (object.userData.animate === 'genomics-vertical-read') {
        const progress = (
          this.elapsed * Number(object.userData.speed ?? 0.02)
          + Number(object.userData.phase ?? 0)
        ) % 1;
        object.position.y = Number(object.userData.baseY ?? object.position.y)
          + progress * Number(object.userData.travel ?? 1);
      } else if (object.userData.animate === 'genomics-gantry-carriage') {
        const angle = this.elapsed * Number(object.userData.speed ?? 0.018) + Number(object.userData.phase ?? 0);
        object.position.set(
          Number(object.userData.centerX ?? 0) + Math.cos(angle) * Number(object.userData.radiusX ?? 1),
          Number(object.userData.baseY ?? object.position.y),
      ...
      } else if (object.userData.animate === 'computational-biology-signal-travel') {
        ...
        object.position.y = Number(object.userData.baseY ?? object.position.y) + (axis === 'y' ? travel : 0);
        object.position.z = Number(object.userData.baseZ ?? object.position.z) + (axis === 'z' ? travel : 0);
      } else if (object.userData.animate === 'computational-biology-path-transit') {
        const path = object.userData.path as Array<[number, number, number]>;
        if (Array.isArray(path) && path.length > 1) {
          const progress = (this.elapsed * Number(object.userData.speed ?? 0.003) + Number(object.userData.phase ?? 0)) % 1;
          const scaled = progress * (path.length - 1); const index = Math.min(path.length - 2, Math.floor(scaled)); const localT = scaled - index;
          object.position.set(
            THREE.MathUtils.lerp(path[index][0], path[index + 1][0], localT),
            THREE.MathUtils.lerp(path[index][1], path[index + 1][1], localT),
      ...
      } else if (object.userData.animate === 'robotics-emissive-pulse') {
        if (object instanceof THREE.Mesh && object.material instanceof THREE.MeshStandardMaterial) {
          const wave = Math.max(0, Math.sin(
            this.elapsed * Number(object.userData.speed ?? 0.006) * Math.PI * 2
            + Number(object.userData.phase ?? 0),
      ...
      } else if (object.userData.animate === 'robotics-rotation') {
        const axis = object.userData.axis === 'x' || object.userData.axis === 'z' ? object.userData.axis : 'y';
        const step = delta * Number(object.userData.speed ?? 0.01);
        if (axis === 'x') object.rotation.x += step;
        else if (axis === 'z') object.rotation.z += step;
        else object.rotation.y += step;
      } else if (object.userData.animate === 'robotics-path-transit') {
        const path = object.userData.path as Array<[number, number, number]>;
        if (Array.isArray(path) && path.length > 1) {
          const progress = (this.elapsed * Number(object.userData.speed ?? 0.0025) + Number(object.userData.phase ?? 0)) % 1;
          const scaled = progress * (path.length - 1); const index = Math.min(path.length - 2, Math.floor(scaled)); const localT = scaled - index;
          object.position.set(
            THREE.MathUtils.lerp(path[index][0], path[index + 1][0], localT),
            THREE.MathUtils.lerp(path[index][1], path[index + 1][1], localT),
        ...
        if (object instanceof THREE.Mesh && object.material instanceof THREE.MeshStandardMaterial) {
          ...
          object.material.emissiveIntensity = THREE.MathUtils.lerp(
            Number(object.userData.minIntensity ?? 0.25),
            Number(object.userData.maxIntensity ?? 4),
            Math.pow(wave, 3),
          );
        }
      } else if (object.userData.animate === 'biochemistry-rotation') {
        const axis = object.userData.axis === 'x' || object.userData.axis === 'z' ? object.userData.axis : 'y';
        const step = delta * Number(object.userData.speed ?? 0.025);
        if (axis === 'x') object.rotation.x += step;
        else if (axis === 'z') object.rotation.z += step;
        else object.rotation.y += step;
      } else if (object.userData.animate === 'biochemistry-path-transit') {
        const path = object.userData.path as Array<[number, number, number]>;
        if (Array.isArray(path) && path.length > 1) {
          const progress = (this.elapsed * Number(object.userData.speed ?? 0.0045) + Number(object.userData.phase ?? 0)) % 1;
          const scaled = progress * (path.length - 1); const index = Math.min(path.length - 2, Math.floor(scaled)); const localT = scaled - index;
          object.position.set(
            THREE.MathUtils.lerp(path[index][0], path[index + 1][0], localT),
            THREE.MathUtils.lerp(path[index][1], path[index + 1][1], localT),
      ...
      } else if (object.userData.animate === 'biochemistry-vertical-transit') {
        const progress = (this.elapsed * Number(object.userData.speed ?? 0.025) + Number(object.userData.phase ?? 0)) % 1;
        object.position.y = Number(object.userData.baseY ?? object.position.y) + progress * Number(object.userData.travel ?? 1);
      } else if (object.userData.animate === 'biochemistry-kinetic-blade') {
        object.rotation.y = Number(object.userData.baseRotationY ?? 0)
          + Math.sin(this.elapsed * 0.035 + Number(object.userData.phase ?? 0)) * 0.42;
      } else if (object.userData.animate === 'biochemistry-phase-drift') {
        const phase = Number(object.userData.phase ?? 0);
        object.position.x = Number(object.userData.baseX ?? object.position.x) + Math.sin(this.elapsed * 0.012 + phase) * 0.28;
        object.position.z = Number(object.userData.baseZ ?? object.position.z) + Math.cos(this.elapsed * 0.01 + phase) * 0.22;
      } else if (object.userData.animate === 'organic-chemistry-emissive-pulse') {
        if (object instanceof THREE.Mesh && object.material instanceof THREE.MeshStandardMaterial) {
          const wave = Math.max(0, Math.sin(
            this.elapsed * Number(object.userData.speed ?? 0.012) * Math.PI * 2
            + Number(object.userData.phase ?? 0),
      ...
      } else if (object.userData.animate === 'organic-chemistry-rotation') {
        const axis = object.userData.axis === 'x' || object.userData.axis === 'z' ? object.userData.axis : 'y';
        const step = delta * Number(object.userData.speed ?? 0.025);
        if (axis === 'x') object.rotation.x += step;
        else if (axis === 'z') object.rotation.z += step;
        else object.rotation.y += step;
      } else if (object.userData.animate === 'organic-chemistry-sway') {
        object.rotation.y = Number(object.userData.baseRotationY ?? 0)
          + Math.sin(this.elapsed * 0.034 + Number(object.userData.phase ?? 0))
          * Number(object.userData.amplitude ?? 0.18);
      } else if (object.userData.animate === 'organic-chemistry-orbit') {
        const angle = this.elapsed * Number(object.userData.speed ?? 0.02) + Number(object.userData.phase ?? 0) * Math.PI * 2;
        object.position.set(
          Number(object.userData.centerX ?? 0) + Math.cos(angle) * Number(object.userData.radiusX ?? 1),
          Number(object.userData.baseY ?? object.position.y),
          Number(object.userData.centerZ ?? 0) + Math.sin(angle) * Number(object.userData.radiusZ ?? 1),
        );
      } else if (object.userData.animate === 'organic-chemistry-charge-transfer') {
        const progress = (this.elapsed * Number(object.userData.speed ?? 0.02) + Number(object.userData.phase ?? 0)) % 1;
        object.position.x = THREE.MathUtils.lerp(
          Number(object.userData.startX ?? object.position.x),
      ...
      } else if (object.userData.animate === 'astronomy-astrobiology-emissive-pulse') {
        if (object instanceof THREE.Mesh && object.material instanceof THREE.MeshStandardMaterial) {
          const wave = Math.max(0, Math.sin(
          ...
          object.material.emissiveIntensity = THREE.MathUtils.lerp(
            Number(object.userData.minIntensity ?? 0.12),
            Number(object.userData.maxIntensity ?? 3.2),
            Math.pow(wave, 3),
          );
        }
      } else if (object.userData.animate === 'astronomy-astrobiology-rotation') {
        const axis = object.userData.axis === 'x' || object.userData.axis === 'z' ? object.userData.axis : 'y';
        const step = delta * Number(object.userData.speed ?? 0.004);
        if (axis === 'x') object.rotation.x += step;
        else if (axis === 'z') object.rotation.z += step;
        else object.rotation.y += step;
      } else if (object.userData.animate === 'materials-science-emissive-pulse') {
        if (object instanceof THREE.Mesh && object.material instanceof THREE.MeshStandardMaterial) {
          const wave = Math.max(0, Math.sin(
            this.elapsed * Number(object.userData.speed ?? 0.004) * Math.PI * 2
            + Number(object.userData.phase ?? 0),
      ...
      } else if (object.userData.animate === 'electronics-emissive-pulse') {
        if (object instanceof THREE.Mesh && object.material instanceof THREE.MeshStandardMaterial) {
          const wave = Math.max(0, Math.sin(
          ...
          object.material.emissiveIntensity = THREE.MathUtils.lerp(
            ...
            Number(object.userData.maxIntensity ?? 2.6),
            Math.pow(wave, 3),
          );
        }
      ...
      } else if (object.userData.animate === 'entertainment-emissive-pulse') {
        if (object instanceof THREE.Mesh && object.material instanceof THREE.MeshStandardMaterial) {
          const wave = Math.max(0, Math.sin(
            this.elapsed * Number(object.userData.speed ?? 0.002) * Math.PI * 2
            + Number(object.userData.phase ?? 0),
      ...
      } else if (object.userData.animate === 'toxicology-emissive-pulse') {
        if (object instanceof THREE.Mesh && object.material instanceof THREE.MeshStandardMaterial) {
          const wave = Math.max(0, Math.sin(
            this.elapsed * Number(object.userData.speed ?? 0.002) * Math.PI * 2
            + Number(object.userData.phase ?? 0),
      ...
      } else if (object.userData.animate === 'toxicology-rotation') {
        const axis = object.userData.axis === 'x' || object.userData.axis === 'z' ? object.userData.axis : 'y';
        const step = delta * Number(object.userData.speed ?? 0.004);
        if (axis === 'x') object.rotation.x += step;
        else if (axis === 'z') object.rotation.z += step;
...
`;
  ...
  getRenderTextSnapshot() {
    ...
    const selectedComputationalBiology = selectedPackageId === 'computational-biology-labs'
      ...
      : null;
    const selectedRobotics = selectedPackageId === 'robotics-labs'
      ? this.objectGroups.get('robotics-labs')?.userData.roboticsLabsDistrict
      : null;
    ...
    const selectedEnvironmentalScience = selectedPackageId === 'environmental-science-labs'
      ...
      : null;
    const selectedToxicology = selectedPackageId === 'toxicology-labs'
      ? this.objectGroups.get('toxicology-labs')?.userData.toxicologyLabsDistrict
      : null;
    ...
    return {
      ...
      computationalBiologyLabsDistrict: selectedComputationalBiology ? {
        ...
        signatureSystems: selectedComputationalBiology.signatureSystems,
      } : null,
      roboticsLabsDistrict: selectedRobotics ? {
        buildingCount: selectedRobotics.buildingCount,
        circulation: selectedRobotics.circulation,
        signatureSystems: selectedRobotics.signatureSystems,
        operationalRule: selectedRobotics.operationalRule,
      } : null,
      electronicsLabsDistrict: selectedElectronics ? {
        buildingCount: selectedElectronics.buildingCount,
        technologicalProgression: selectedElectronics.technologicalProgression,
        circulation: selectedElectronics.circulation,
      ...
      entertainmentDistrict: selectedEntertainment ? {
        buildingCount: selectedEntertainment.buildingCount,
        zones: selectedEntertainment.zones,
        circulation: selectedEntertainment.circulation,
        signatureSystems: selectedEntertainment.signatureSystems,
      ...
      astronomyAstrobiologyLabsDistrict: selectedAstronomyAstrobiology ? {
        ...
        darkSkyProtocol: selectedAstronomyAstrobiology.darkSkyProtocol,
        signatureSystems: selectedAstronomyAstrobiology.signatureSystems,
      } : null,
      materialsScienceLabsDistrict: selectedMaterialsScience ? {
        buildingCount: selectedMaterialsScience.buildingCount,
      ...
      toxicologyLabsDistrict: selectedToxicology ? {
        buildingCount: selectedToxicology.buildingCount,
        scientificSequence: selectedToxicology.scientificSequence,
        functionalSequence: selectedToxicology.functionalSequence,
        circulation: selectedToxicology.circulation,
        signatureSystems: selectedToxicology.signatureSystems,
        lightingProtocol: selectedToxicology.lightingProtocol,
      } : null,
  ...
  getTextSnapshot() {
    ...
    const toxicologyLabsDistrict = this.objectGroups.get('toxicology-labs')?.userData.toxicologyLabsDistrict ?? null;
