...
export function createDistrictModel(definition: DistrictDefinition): ProceduralModel {
  ...
  switch (definition.category) {
    ...
    case 'bioscience':
      ...
      break;
    case 'engineering':
      if (definition.id === 'materials-science-lab') buildMaterialsScienceLabsDistrict(group, definition);
